            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <article class="panel portfolio-effect-item">
                    <div class="pro-img-box">
                        <a class="fancybox" rel="group<?=$data["page_id"]?>" title="<?=$item['name']?>" href="<?=base_url().$item['image']?>"><img src="<?=base_url()?><?=image($item['image'],$settings['default_image'],300,200)?>" alt="<?=$item['name']?>" title="<?=$item['name']?>" style="width:100%;"/></a>
                    </div>
