<section class="card">
    ...
    <div class="card-body">
        <div class="nodcms-sortable-list dd" id="data_list_<?php echo $page; ?>" data-output="#output_<?php echo $page; ?>" data-visibility-btn=".visibility" data-save-btn="#save-sort-<?php echo $page; ?>" data-key="<?php echo $page; ?>">
...
<?php $this->load->addJsFile("assets/nodcms/js/netstable-x.min"); ?>