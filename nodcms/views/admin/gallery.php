            ...
            <table  class="display table table-bordered table-striped" id="data_list">
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                        ...
                        <td>
                            <a href="<?=$base_url?>gallery_upload/<?=$data["gallery_id"]?>/<?=$data["data_type"]?>/<?=$data["relation_id"]?>" class="btn btn-success btn-sm" title="<?=_l('Photo Edit',$this)?>"><i title="<?=_l('Photo Edit',$this)?>" class="fa fa-picture-o"></i> <?=_l('Photo Edit',$this)?></a>
                            <a href="<?=$base_url?>edit<?=$page?>/<?=$data["gallery_id"]?>" class="btn btn-primary btn-sm" title="<?=_l('Edit',$this)?>"><i title="<?=_l('Edit',$this)?>" class="fa fa-pencil"></i></a>
                            <a href="<?=$base_url?>delete<?=$page?>/<?=$data["gallery_id"]?>" class="btn btn-danger btn-sm" title="<?=_l('Delete',$this)?>"><i title="<?=_l('Delete',$this)?>" class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
