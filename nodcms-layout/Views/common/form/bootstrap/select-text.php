<div class="input-group">
    <div class="input-group-prepend">
        <div class="input-group-text">
            <input name="<?php echo $name; ?>_radio" data-role="toggle-disabled" data-target="#<?php echo $field_id."_select"; ?>" id="<?php echo $field_id."_radio"; ?>" type="radio"<?php echo !in_array($default, array_column($options,$option_value))?"":"checked"; ?> onclick="$('#<?php echo $field_id; ?>').val($('#<?php echo $field_id; ?>_select').val());">
        </div>
    </div>
...
<div class="input-group margin-top-5">
    <div class="input-group-prepend">
        <div class="input-group-text">
            <input name="<?php echo $name; ?>_radio" data-role="toggle-disabled" data-target="#<?php echo $field_id; ?>" id="<?php echo $field_id."_radio"; ?>" type="radio" <?php echo !in_array($default, array_column($options,$option_value))?"checked":""; ?>>
        </div>
    </div>
