...
<?php } ?>
<textarea name="<?php echo $name; ?>" id="<?php echo $field_id; ?>" data-loading="#<?php echo $field_id; ?>-loading" class="form-control ckeditor <?php echo $class; ?>" <?php foreach ($attr as $key=>$value){ echo $key.' = "'.$value.'"'; } ?>><?php echo $default; ?></textarea>
