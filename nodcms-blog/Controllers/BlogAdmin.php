...
class BlogAdmin extends Backend
{
     ...
     * @throws \Exception
     */
    public function postDelete($id, $confirm = 0)
    {
        if (!Services::identity()->isAdmin()) {
            return Services::identity()->getResponse();
        }
...
//                ),
     ...
     * @throws \Exception
     */
    public function categorySubmit(int $id = 0)
    {
     ...
     * @throws \Exception
     */
    public function categoryDelete($id, $confirm = 0)
    {
        if (!Services::identity()->isAdmin()) {
            return Services::identity()->getResponse();
        }
     ...
     * @throws \Exception
     */
    public function commentSubmit(int $post_id = 0, int $id = 0)
    {
        $back_url = BLOG_ADMIN_URL."comments";
     ...
     * @throws \Exception
     */
    public function commentDelete($id, $confirm = 0)
    {
        if (!Services::identity()->isAdmin()) {
            return Services::identity()->getResponse();
        }
