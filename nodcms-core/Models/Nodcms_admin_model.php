...
class Nodcms_admin_model extends CoreModel
{
     ...
     * @return bool
     */
    public function updateSettings($data = null, $language_id = 0)
    {
    ...
    public function get_all_language($conditions=null)
    {
        $this->db->select("*");
    ...
    public function menu_manipulate($data, $id=0)
    {
        $this->db->trans_start();
     ...
     * @return mixed
     */
    public function getLastRegistrations($per_page = 10)
    {
        $this->db->select("*");
        $this->db->from('users');
     ...
     * @return mixed
     */
    public function getAllUser($page = null, $per_page = 10)
    {
        $this->db->select("*");
        $this->db->from('users');
        $this->db->join('groups', 'users.group_id = groups.group_id');
    ...
    public function userManipulate($data, $id=null)
    {
        $this->db->trans_start();
    ...
    public function socialLinksManipulate($data, $id=null)
    {
        $this->db->trans_start();
     ...
     * @return mixed
     */
    public function getArticles($conditions = null)
    {
        $this->db->select("*");
     ...
     * @param $languages
     */
    public function updateTitles($table, $id, $values, $languages)
    {
     ...
     * @param $list
     */
    public function removeListWithTitle($table, $key, $list)
    {
     ...
     * @return mixed
     */
    public function getUploadedSize($conditions = null)
    {
     ...
     * @return bool
     */
    public function checkUserUnique($conditions, $id)
    {
        $this->db->select("*");
        $this->db->from('users');
        $this->db->where($conditions);
