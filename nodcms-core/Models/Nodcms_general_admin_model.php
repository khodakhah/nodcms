...
class Nodcms_general_admin_model extends CoreModel
{
    ...
    public function edit_setting($data=null)
    {
        $this->db->where('id', 1);
    ...
    public function get_language_detail($id)
    {
        $this->db->select('*');
        $this->db->from('languages');
    ...
    public function language_manipulate($data, $id=null)
    {
        $this->db->trans_start();
    ...
    public function get_all_menu($conditions=null)
    {
        $this->db->select('*');
        $this->db->from('menu');
        if ($conditions!=null) {
    ...
    public function menu_manipulate($data, $id=null)
    {
        $this->db->trans_start();
        ...
        if (isset($titles)) {
            ...
            foreach ($titles as $key=>$value) {
                if ($value!='') {
                    $this->db->insert('titles', array("language_id"=>$key,"title_caption"=>$value,"relation_id"=>$id,"data_type"=>"menu"));
                }
            }
        }
    ...
    public function currency_manipulate($data, $id=null)
    {
        $this->db->trans_start();
    ...
    public function get_comment_detail($id, $replay=null)
    {
        $this->db->select('*,comments.status,comments.created_date');
        $this->db->from('comments');
        $this->db->join('users', "users.user_id=comments.user_id");
    ...
    public function comment_manipulate($data, $id=null)
    {
        $this->db->trans_start();
    ...
    public function comment_replay_manipulate($data, $id)
    {
        $this->db->trans_start();
        if ($this->session->userdata('group') != 1 && isset($data['status'])) {
            unset($data['status']);
    ...
    public function user_manipulate($data, $id=null)
    {
        $this->db->trans_start();
    ...
    public function get_country_detail($id)
    {
        $this->db->select('*');
        $this->db->from('country');
    ...
    public function country_manipulate($data, $id=null)
    {
        $this->db->trans_start();
        ...
        if (isset($titles)) {
            foreach ($titles as $key=>$value) {
                if ($value!='') {
                    $this->db->insert('titles', array("language_id"=>$key,"title_caption"=>$value,"relation_id"=>$id,"data_type"=>"country"));
                }
            }
        }
    ...
    public function get_all_extension($data_type=null, $relation_id=null)
    {
    ...
    public function get_extension_detail($id)
    {
        $this->db->select('*');
        $this->db->from('extensions');
    ...
    public function extension_manipulate($data, $id=null)
    {
        $this->db->trans_start();
    ...
    public function get_all_panel($data_type=null, $relation_id=null)
    {
        $this->db->select("*");
        $this->db->from('panels');
    ...
    public function get_panel_detail($id)
    {
        $this->db->select('*');
        $this->db->from('panels');
    ...
    public function panel_manipulate($data, $id=null)
    {
        $this->db->trans_start();
    ...
    public function city_manipulate($data, $id=null)
    {
        $this->db->trans_start();
        if ($this->session->userdata('group') != 1 && isset($data['public'])) {
            unset($data['public']);
        ...
        if (isset($titles)) {
            foreach ($titles as $key=>$value) {
                if ($value!='') {
                    $this->db->insert('titles', array("language_id"=>$key,"title_caption"=>$value,"relation_id"=>$id,"data_type"=>"city"));
                }
            }
        }
    ...
    public function page_manipulate($data, $id=null)
    {
        $this->db->trans_start();
        ...
        if (isset($titles)) {
            ...
            foreach ($titles as $key=>$value) {
                if ($value!='') {
                    $this->db->insert('titles', array("language_id"=>$key,"title_caption"=>$value,"relation_id"=>$id,"data_type"=>"page"));
                }
            }
        }
    ...
    public function get_search_page($data)
    {
        $this->db->select("*");
        $this->db->from('page');
    ...
    public function get_gallery($data_type=null, $relation_id=null)
    {
        $this->db->select("*");
    ...
    public function get_gallery_detail($gallery_id)
    {
        $this->db->select("*");
        $this->db->from('gallery');
    ...
    public function get_insert_gallery($data)
    {
        $this->db->trans_start();
        $data['created_date']=time();
    ...
    public function gallery_manipulate($data, $id=null)
    {
        $this->db->trans_start();
        ...
        if (isset($titles)) {
            foreach ($titles as $key=>$value) {
                if ($value!='') {
                    $this->db->insert('titles', array("language_id"=>$key,"title_caption"=>$value,"relation_id"=>$id,"data_type"=>"gallery"));
                }
            }
        }
    ...
    public function get_gallery_image($gallery_id)
    {
        $this->db->select("*");
    ...
    public function get_gallery_image_detail($gallery_image_id)
    {
        $this->db->select("*");
        $this->db->from('gallery_image');
    ...
    public function get_insert_gallery_image($data)
    {
        $this->db->trans_start();
        $data['created_date']=time();
    ...
    public function get_image_detail($image_id)
    {
        $this->db->select("*");
        $this->db->from('images');
    ...
    public function get_all_titles($data_type=null, $relation_id=null)
    {
        $this->db->select("*");
        $this->db->from('titles');
        $this->db->where('data_type', $data_type);
    ...
    public function count_extensions($where = null)
    {
    ...
    public function count_comment($where = null)
    {
        $this->db->select("count(*)");
        $this->db->from('comments');
        if ($where!=null) {
    ...
    public function count_page($where = null)
    {
        $this->db->select("count(*)");
        $this->db->from('page');
        if ($where!=null) {
    ...
    public function count_gallery($where = null)
    {
        $this->db->select("count(*)");
        $this->db->from('gallery');
        if ($where!=null) {
    ...
    public function count_gallery_image($where = null)
    {
        $this->db->select("count(*)");
        $this->db->from('gallery_image');
        if ($where!=null) {
    ...
    public function count_uploaded_image($where = null)
    {
        $this->db->select("count(*)");
        $this->db->from('images');
        if ($where!=null) {
    ...
    public function get_all_setting_options()
    {
        $this->db->select("*");
    ...
    public function check_setting_options($language_id)
    {
        $this->db->select("count(*)");
        $this->db->from('setting_options_per_lang');
    ...
    public function edit_setting_options($language_id, $data)
    {
        $this->db->where('language_id', $language_id);
        $this->db->update('setting_options_per_lang', $data);
    }
    public function insert_setting_options($language_id, $data)
    {
    ...
    public function get_statistic_max_visitors()
    {
    ...
    public function get_statistic_total_visits()
    {
    ...
    public function get_statistic_total_visitors()
    {
