...
class CI_Ckeditor
{
	...
	private function configSettings($config = array(), $events = array())
	{
		$_config = $this->config;
		$_events = $this->events;
		$_config['height'] = isset($_config['height'])?$_config['height']:400;      //DKW
		$_config['width'] = isset($_config['width'])?$_config['width']:NULL;        //DKW
		$_config['toolbar'] =isset($_config['toolbar'])?$_config['toolbar']:'Full'; //DKW  --- related to the config.js
