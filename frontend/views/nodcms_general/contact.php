          ...
          <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
              ...
              <form class="" id="contact" onsubmit="return check_request();" action="<?=base_url()?>sendemail" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <textarea id="text" class="form-control" rows="3" name="data[text]"></textarea>
                  </div>
                  <div class="form-group text-center">
                      <input type="submit" class="btn btn-primary" value="<?=_l('Send email',$this);?>"/>
                  </div>
              </form>
          </div>
          <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
