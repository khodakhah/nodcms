<?php if(isset($data) && count($data)!=0){ ?>
    <div class="row row-color bg-primary group-effect">
        <div class="container">
                    ...
                    <div class="group-effect-item">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div><img class="img-circle" src="<?=base_url()?><?=image($item['image'],$settings['default_image'],200,200)?>" style="width: 100%;"></div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <h3><?=$item['name']?></h3>
